...
from app.pricers.bond import registration as bond
from app.pricers.european_option import registration as european_option
from app.pricers.irs import registration as irs
from app.pricers.spot import registration as spot
